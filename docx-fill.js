...
(function (global) {
  ...
  async function fillXml(xml, payload) {
    ...
    const charterFee = parseFloat(feeCharterRaw) || 0;
    const delivery = parseFloat(feeDeliveryRaw) || 0;
    const apa = parseFloat(feeApaRaw) || 0;
    const security = parseFloat(feeSecurityRaw) || 0;
    const totalCharter = charterFee + delivery;
    const totalInvoice = totalCharter + apa + security;
    const deposit = parseFloat(feeDepositRaw) || 0;
